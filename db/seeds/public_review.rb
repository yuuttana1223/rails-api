...
Review.create!(
  [
    ...
    {
      user_id: user.id, lecture_name: "XML入門", teacher_name: "酒井辰也", lesson_type: "リアルタイムオンライン", level_of_satisfaction: "満足", workload: "少ない", difficulty: "易しい", is_ending_test: false, content: "授業中に終わる量の課題のなので授業外に時間を取られることはない。XMLを将来使うところがあまり想像はできなかったが、Androidを作りたいと思う人は使うと思うのでやっておいて損はないと思う。パワーポイントがとても分かりやすく、他の授業もこの先生のものは受けたい。",
    },
    {
      user_id: user.id, lecture_name: "Linux実習", teacher_name: "青木成一郎", lesson_type: "ハイブリッド", level_of_satisfaction: "普通", workload: "少ない", difficulty: "易しい", is_ending_test: false, content: "Linuxコマンドは仕事やアプリ作成でも役に立つので知っていないといけないことばかりの内容だが、後半はいつ使うのか微妙な内容まで含まれる。基本的に授業内で完結する課題が多いが、まれに授業外の課題も出る。Windowsが基本なのでMacの人は多少調べなければならない。進むスピードも遅く、生徒が質問するたびに遅れていくので最後まで授業の内容を終えれない。既にコマンドを知っている人には退屈かもしれない。",
    },
    {
    ...
    {
      user_id: user.id, lecture_name: "HTML・CSS実習", teacher_name: "水井英二", lesson_type: "オンデマンド", level_of_satisfaction: "普通", workload: "普通", difficulty: "易しい", is_ending_test: true, content: "HTMLとCSSを体系的に学ぶことができるが、内容は割と詰め込まれているので経験者じゃないと覚えきれないかもしれない。資料と動画が用意されているが、基本的には動画は資料を読むだけなので動画は見なくても良いと思った。小テストが毎回あるが、資料を見ながらやれば満点は取れる。期末テストも小テストから出るので問題をまとめておくと良いと感じた。",
    },
    {
    ...
    {
      user_id: user.id, lecture_name: "FE対策演習", teacher_name: "大山口雅", lesson_type: "リアルタイムオンライン", level_of_satisfaction: "満足", workload: "大変少ない", difficulty: "大変易しい", is_ending_test: true, content: "とても話が分かりやすくて、理解できた。とても人柄が良くて、遅刻しても許してくれる。問題をあらかじめ解いておかないと全く身につかないので、それが嫌な人は話を聞き流して、期末テストだけやるのもありだと思った。期末テストの内容はGoogle検索をすると出てくるので、理解してなくても満点が取れてしまう。",
    },
    {
    ...
    {
      user_id: user.id, lecture_name: "プロジェクト演習2", teacher_name: "前納一希", lesson_type: "ハイブリッド", level_of_satisfaction: "満足", workload: "普通", difficulty: "普通", is_ending_test: false, content: "チーム開発ができる数少ない授業だが、うまくチームが作れないときついのかなと思った。プロジェクト演習2は半年しかなくて時間が足りないので授業外にもやっているチームも見受けられた。先生自体は質問にいつでも答えられる態勢を取っており、雑談も面白かった。GitやDockerなどのハンズオンを授業中に数時間程度取っていたが、初心者には難しく、知っている人には簡単すぎるので数時間程度でやるにはきついと感じた。予想通りGitやDockerを使っているチームはあまりなかった。",
    },
  ]
)